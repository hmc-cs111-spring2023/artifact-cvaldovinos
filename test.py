...
class TestParser(unittest.TestCase):
    ...
    def test_fv_0(self):
        ...
        self.assertEqual(input, ['r = 0.05/12', 'nper = 10*12', '$100 payments', 'a present value of 100'])
    ...
    def test_fv_3(self):
        ...
        self.assertEqual(input, ['r = 0.05/12', 'nper = 10*12', 'pmt = -100', 'pv = -100'])
        self.assertEqual(functionName, "FV")
    ...
    def test_pv_0(self):
        ...
        self.assertEqual(input, ['r = 0.05/12', 'nper = 10*12', 'pmt of -100'])
    ...
    def test_pv_3(self):
        ...
        self.assertEqual(input, ['r = 0.05/12', 'nper = 10*12', 'pmt = -100'])
        self.assertEqual(functionName, "PV")
    ...
    def test_npv_0(self):
        ...
        self.assertEqual(input, ['r = 0.08', 'cash_flows of [-100, 39, 59, 55, 20]'])
        self.assertEqual(functionName, "NPV")

    def test_npv_1(self):
        input, functionName = parse(NPV_TESTCASES[1])

        self.assertEqual(input, ['r = 8%', 'cash_flows of [-100, 39, 59, 55, 20]'])
        self.assertEqual(functionName, "NPV")
    ...
    def test_npv_7(self):
        ...
        self.assertEqual(input, ['r = 8%', 'cash_flows = [-100, 39, 59, 55, 20]'])
        self.assertEqual(functionName, "NPV")
